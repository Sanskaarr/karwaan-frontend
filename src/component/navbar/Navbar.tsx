...
import Hamburger from "../menuIcon/Hamburger";
    ...
    <>
      {!pathname.includes("/gallery") && (
        <div
          ...
          style={
            pathname === "/" || pathname === "/contact" || pathname === "/user"
        ...
        >
          ...
          {pathname === "/" ? (
            <div
              className={`${styles.contact} ${styles.uppercase} ${styles.hover}`}
            ...
            >
              <div
                className={`${styles.contactLine} ${styles.uppercase} ${styles.hover}`}
                onClick={() => router.push("/contact")}
              ...
              <a
                ...
                style={
                  pathname === "/"
                    ...
                    : {
                        filter:
                          " invert(100%) sepia(100%) saturate(0%) hue-rotate(71deg) brightness(104%) contrast(104%)",
                      }
                }
              >
                <img
          ...
          {/* Menu when open and close */}
            <div className={styles.rightNav}>
          {isMenuOpen ? (
            <>
                <div className={styles.menuOptions }>
                <ul className={styles.menuOptionsAnimate}>
                ...
                (
                  ...
                  >
                    <a
                      onClick={() => router.push("/")}
                      style={
                        pathname === "/" ? { color: "white" } : { display: "none" }
                      }
                    >
                      <img
                        src="https://karwaan.b-cdn.net/Front/KARWAANLOGOWHITE%20(Custom).png"
                  ...
                  {!pathname.includes("/products") ? (
                    <div
                      className={`${styles.closeMenu} ${styles.uppercase}`}
                      onClick={() => {
                        setIsMenuOpen(!isMenuOpen);
                      }}
                    >
                      <div
                        className={`${styles.menu} ${styles.uppercase} ${styles.hover}`}
                        style={
                ...
                {
                  !pathname.includes("/products") &&
                  <Hamburger isActive={isMenuOpen} toggleActive={() => {setIsMenuOpen(!isMenuOpen)}} />
                }
      ...
      >
        ...
        >
          <CloseOutlined
            className={styles.userSettingClose}
            onClick={() => setIsUserMenuOpen(!isUserMenuOpen)}
          />
        ...
        >
          ...
          <li
            className={styles.userSettingLogOut}
            onClick={(e) => {
              handleLogOutUser(e);
              setIsUserMenuOpen(!isUserMenuOpen);
            }}
