  ...
  return (
    <div className={styles.Picture}>
      <div className={styles.PictureSection}>
        <div
          className={styles.PictureSectionHome}
          style={{ position: "relative", zIndex: "3", background: "white" }}
        >
          <span style={{ color: "black" }} onClick={() => router.push("/")}>
            Home
          </span>
        </div>
        ...
        {
          <div
            className={styles.PictureSectionFilter}
            style={
              isMenuHide
                ? {
                    visibility: "hidden",
          ...
          >
            <h3
              className={styles.desktopViewFilter}
              style={
                isMenuHide
                  ? {
                      visibility: "visible",
            ...
            >
              <span>filter by :</span><span style={{textDecoration:"underline", marginLeft:"2px" , textDecorationThickness:"1px", textUnderlineOffset:"2px"}}>{filter}</span>
            </h3>
            <ul
              ...
              {filterOptions.map((option, index) => {
                return (
                  <li
                    ...
                    style={
                      option === filter
                        ? { textDecoration: "line-through", zIndex: "-1" }
        ...
        {/* </div> */}
        <div className={styles.PictureGallary} ref={pictureContainerRef}>
          {galleryData ? (
            galleryData.length ? (
              galleryData
                ...
                .map((data: any) => {
                  return (
                    <div key={data.id} className={styles.imageSection}>
                      <motion.img
                        initial={{ scale: 0.3, x: 100, y: 0, opacity: 0 }} // Set initial position and opacity
      ...
      <div className={styles.PictureScrollBar}>
        <div
          className={styles.PictureScrollBarLeft}
          style={{
            visibility: "visible",
            pointerEvents: "all",
            transition: "all 0.4s",
        ...
        <div className={styles.PictureScrollBarRightSide}>
          {isMenuHide ? (
            <div
              className={styles.pictureMenuShow}
            ...
            <div
              className={styles.pictureMenuHide}
              onClick={() => setIsMenuHide(!isMenuHide)}
            >
          ...
          <div
            className={styles.PictureScrollBarRight}
